...
static VALUE
reparent_node_with(VALUE pivot_obj, VALUE reparentee_obj, pivot_reparentee_func profile)
{
...
ok:
  ...
  if (profile != xmlAddPrevSibling && profile != xmlAddNextSibling && profile != xmlAddChild
  ...
  if (!(reparented = (*profile)(pivot, reparentee))) {
